  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>軽音楽部と軽音サークルのPop’n Light Partyが合同でライブを行います! </p>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
      ...
      <>
        <table>
          ...
          <tbody>
            <tr>
              <td>101</td>
              <td>10/12: <br />10/13: </td>
              <td>怨霊の金縛り屋敷</td>
            </tr>
            <tr>
              <td>102</td>
              <td>10/12: 9:30～18:00<br />10/13: 9:30～16:00</td>
              <td>島大いきもの博物館／ザリガニ・カニ釣り (総合環境サークル エコロジー・ネットワーク) </td>
            </tr>
            <tr>
              <td>201</td>
              <td>10/12: 9:30～16:00<br />10/13: 9:30～15:00</td>
              <td>ダンボール迷路</td>
            </tr>
            <tr>
              <td>202</td>
              <td>10/12: 14:00～15:00</td>
              <td>あちゃらかネタライブ!! feat. ブーゲンビリア (島根大学お笑いサークル「あちゃらか」) </td>
            </tr>
            <tr>
              <td>202</td>
              <td>10/13: 14:00～15:00</td>
              <td>あちゃらか大喜利決定戦!! (島根大学お笑いサークル「あちゃらか」) </td>
            </tr>
            <tr>
              <td>301</td>
              <td>10/12: 9:30～18:00<br />10/13: 9:30～16:00</td>
              <td>美術科教育専攻・作品展示会 －まじわるところ－ (美術科教育専攻) </td>
            </tr>
          </tbody>
        </table>
      </>
      ...
      <>
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>502</td>
              <td>10/12: 10:00～17:30<br />10/13: 10:00～15:30</td>
              <td>不昧流茶道部お茶席 (不昧流茶道部) </td>
            </tr>
            <tr>
              <td>503</td>
              <td>10/12: 9:30～材料なくなり次第終了<br />10/13: 9:30～材料なくなり次第終了</td>
      ...
      <>
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>147 セミナー室</td>
              <td>10/12: 10:00～16:00<br />10/13: 10:00～16:00</td>
              <td>古文書ゼミ展示 (古文書ゼミ) </td>
            </tr>
            <tr>
              <td>241</td>
              <td>10/12: 9:30～17:00<br />10/13: 9:30～16:00</td>
        ...
        <table>
          ...
          <tbody>{/*
            ...
            <tr>
              ...
              <td>遊んで，学ぼう! ／アプリを使って，数学を視る (数理科学科) </td>
            </tr>
          </tbody>
        </table>
      </>
      ...
      <>
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>614</td>
              <td>10/12: 10:00～12:00，13:00～15:00<br />10/13: 10:00～12:00，13:00～15:00</td>
      ...
      <>
        <table>
          ...
          <tbody>
            <tr>
              <td>島大総合博物館アシカル</td>
              <td>10/12: 10:00～17:00<br />10/13: 10:00～16:00</td>
              <td>展示クイズに答えて島大グッズをもらおう (島根大学総合博物館アシカル) </td>
            </tr>
            <tr>
              <td>外国語教育センター Global Hub</td>
              <td>10/12: 10:00～16:00</td>
              <td>カフェ&留学生ポスター発表 (外国語教育センター Global Hub) </td>
            </tr>
          </tbody>
        </table>
      </>
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">10/12: 9:30～18:00<br />10/13: 9:30～15:00</h3>
        <p>射的や赤外線で行う弾が出ないサバゲー等のサバイバルゲーム部の活動を体験していただけるブースを開催しております! ぜひ遊びに来てください! </p>
      </>
    ),
  },
  // 屋外企画
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>私たちは教育学部音楽科教育専攻生です。「やきそばさっちゃん」という店名で，毎年焼きそばを販売しています。今年も丹精込めてつくった焼きそばを販売します。皆様のご来店，お待ちしております! </p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>大学祭フードの“王道”は，この一本。外はカリッ，中は肉汁ジュワッ。厳選肉を高品質な鉄板で丁寧に焼き上げました。香りだけでもお腹が鳴る特製牛串は，大学祭の食べ歩きコースにぴったりです! 売り切れ御免。</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>今年の学祭では，“心も体も満たされる『合氣ドーナツ』”
        を販売します。合気道の精神とドーナツの美味しさが，ここで出会います。柔軟な心とお腹を満たす甘いひとときをお楽しみください! </p>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        <p>ジョブカフェしまねブースでは，就職活動などに関連したイベントの案内を行っております!</p>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>いろんな種類のベビーカステラとドリンク (冷たいものも温かいものもあります) を売ってます!ぜひ足を運んで下さい! </p>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 10:00～16:00<br />10/13: 10:00～16:00</h3>
        <p>プロ美容師によるヘアアレンジを体験できます! ぜひお越しください! ! </p>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>肉の旨味がジュワッ! 外は香ばしく中はほっかほか，フラット特製「肉巻きおにぎり」登場! 秘伝のタレが染み込んだジューシーなお肉でごはんを包み，一口食べれば笑顔間違いなし! 学園祭限定，この味を見逃すな! </p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 10:00～17:00<br />10/13: 10:00～15:00</h3>
        <p>スナフキンでは缶ジュースを販売します! ライブのお供にいかがでしょうか？</p>
      </>
    ),
  },
  {
    id: 31,
    position: { lat: 35.485890, lng: 133.067450 },
    title: "スナフキンライブ",
    description: (
      <>
        <h3 className="op">スナフキン</h3>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>スナフキンでは，ギター，カホン，キーボード，打楽器など，さまざまな楽器を用いたライブ演奏を2日間にわたって行います。</p>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        水泳部は，綿菓子と飲み物を販売します。綿菓子は「ちんちろ」で出目に応じてサイズが変化! 運試しで<p>特大サイズを狙おう! </p>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>下東川津の居酒屋バイトが出店! 炭火の団子と焼き鳥が絶品! ! バイトも募集中♡</p>
      </>
    ),
  },/*
  {
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>ESS部による餃子パーティー。韓国版の餃子を販売。夕方からはクレープ販売の可能性もあります。</p>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>ダーツ部では，実際のダーツを投げる体験とワッフルの販売を行います。賞品も用意しています! </p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>小学校教育専攻4回生によるベビーカステラ販売。ミニゲームでトッピング無料などの企画も。</p>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>献血推進サークルぐっぱと赤十字奉仕団ぷらすによる輸血パックジュースとアイス販売。献血協力者には割引・トッピング特典あり。</p>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～12:00<br />10/13: 9:30～16:00</h3>
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00 (無くなり次第終了) </h3>
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>軽音楽部によるアイスフロート入りドリンクとオリジナルグッズ (タオル・ラバーバンド等) 販売。</p>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>鳥，好きになりました。-島吹編– 現役大学生たちの"運命の鳥とたれの文化祭" リアルで等身大な，本気の"鳥"と"たれ"を追いかけます 果たしてあなたたちは運命の焼き鳥をみつけることができるのか?</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～17:00<br />10/13: 9:30～16:00</h3>
        <p>BBS ボランティアサークルによるポップコーン販売 (複数フレーバーあり) 。</p>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 10:00～18:00<br />10/13: 10:00～16:00</h3>
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～18:00<br />10/13: 9:30～16:00</h3>
        <p>美術科教育専攻による鋳造アニマル制作ワークショップおよび部員作品販売。</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">10/12: 11:00～14:00<br />10/13: 11:00～14:00</h3>
        <p>色んな果物をアメでコーティングしたフルーツアメ販売 (部活動: アイスホッケー部) 。</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 10:00～売り切れまで<br />10/13: 10:00～売り切れまで</h3>
        <p>天文部によるクレープ販売。学祭期間中の合間にぜひお立ち寄りください。</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <p>私たちは，地域人材育成コース，コース生プロジェクトの一環として，島根スサノオマジックとの合同プロジェクトを行っています。今回の大学祭では，体験型の活動を通して，バスケットボールや島根スサノオマジックの魅力について知っていただけたらと思っています。</p>
      </>
    ),
  },
  {
    id: 59,
    position: { lat: 35.486190, lng: 133.067718 },
    title: "A.クロスワード",
    description: (
      <>
        <h3 className="area">本部テント</h3>
        <h3 className="time">
        10/12: 9:30～16:00<br />10/13: 9:30～15:00</h3>
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <h3 className="time">
        10/12: 9:30～11:30，13:00～16:00<br />10/13: 9:30～11:30，13:00～16:00</h3>
        <p>受付: 正門横駐車場</p>
      </>
    ),
  },
